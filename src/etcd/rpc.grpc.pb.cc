...
Cluster::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Cluster::Service, ::etcdserverpb::MemberPromoteRequest, ::etcdserverpb::MemberPromoteResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Cluster::Service* service,
             ::grpc::ServerContext* ctx,
             const ::etcdserverpb::MemberPromoteRequest* req,
             ::etcdserverpb::MemberPromoteResponse* resp) {
               return service->MemberPromote(ctx, req, resp);
             }, this)));
}
