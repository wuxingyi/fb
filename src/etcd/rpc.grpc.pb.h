...
class Cluster final {
 public:
  ...
  template <class BaseClass>
  class WithCallbackMethod_MemberPromote : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_MemberPromote() {
      ::grpc::Service::MarkMethodCallback(4,
          new ::grpc::internal::CallbackUnaryHandler< ::etcdserverpb::MemberPromoteRequest, ::etcdserverpb::MemberPromoteResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::etcdserverpb::MemberPromoteRequest* request, ::etcdserverpb::MemberPromoteResponse* response) { return this->MemberPromote(context, request, response); }));}
    void SetMessageAllocatorFor_MemberPromote(
        ::grpc::MessageAllocator< ::etcdserverpb::MemberPromoteRequest, ::etcdserverpb::MemberPromoteResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(4);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::etcdserverpb::MemberPromoteRequest, ::etcdserverpb::MemberPromoteResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~WithCallbackMethod_MemberPromote() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status MemberPromote(::grpc::ServerContext* /*context*/, const ::etcdserverpb::MemberPromoteRequest* /*request*/, ::etcdserverpb::MemberPromoteResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* MemberPromote(
      ::grpc::CallbackServerContext* /*context*/, const ::etcdserverpb::MemberPromoteRequest* /*request*/, ::etcdserverpb::MemberPromoteResponse* /*response*/)  { return nullptr; }
  };
  typedef WithCallbackMethod_MemberAdd<WithCallbackMethod_MemberRemove<WithCallbackMethod_MemberUpdate<WithCallbackMethod_MemberList<WithCallbackMethod_MemberPromote<Service > > > > > CallbackService;
  typedef CallbackService ExperimentalCallbackService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_MemberPromote : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_MemberPromote() {
      ::grpc::Service::MarkMethodRawCallback(4,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->MemberPromote(context, request, response); }));
    }
    ~WithRawCallbackMethod_MemberPromote() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status MemberPromote(::grpc::ServerContext* /*context*/, const ::etcdserverpb::MemberPromoteRequest* /*request*/, ::etcdserverpb::MemberPromoteResponse* /*response*/) override {
  ...
  class WithStreamedUnaryMethod_MemberPromote : public BaseClass {
   ...
   public:
    WithStreamedUnaryMethod_MemberPromote() {
      ::grpc::Service::MarkMethodStreamed(4,
        new ::grpc::internal::StreamedUnaryHandler<
          ::etcdserverpb::MemberPromoteRequest, ::etcdserverpb::MemberPromoteResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::etcdserverpb::MemberPromoteRequest, ::etcdserverpb::MemberPromoteResponse>* streamer) {
                       return this->StreamedMemberPromote(context,
                         streamer);
                  }));
    }
